...
<body id="mains">
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alazeaNav">
                        ...
                        <a href="index.html" class="nav-brand"><img
                                src="{{asset('assets/frontend/img/core-img/logo.png')}}" alt=""></a>
    ...
    <div class="hero-post-slides owl-carousel">
        ...
        <div class="single-hero-post bg-overlay">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url({{asset('assets/frontend/img/bg-img/1.jpg')}})">
            </div>
        ...
        <div class="single-hero-post bg-overlay">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url({{asset('assets/frontend/img/bg-img/2.jpg')}});">
            </div>
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
    ...
    <!-- ##### Footer Area Start ##### -->
    <footer class="footer-area bg-img" style="background-image: url({{asset('assets/frontend/img/bg-img/3.jpg')}});">
        <!-- Main Footer Area -->
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="single-best-seller-product d-flex align-items-center">
                                <div class="product-thumbnail">
                                    <a href="shop-details.html"><img src="{{asset('assets/frontend/img/bg-img/4.jpg')}}"
                                            alt=""></a>
                                </div>
                            ...
                            <div class="single-best-seller-product d-flex align-items-center">
                                <div class="product-thumbnail">
                                    <a href="shop-details.html"><img src="{{asset('assets/frontend/img/bg-img/5.jpg')}}"
                                            alt=""></a>
                                </div>
                                <div class="product-info">
